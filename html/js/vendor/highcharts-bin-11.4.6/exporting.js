   ...
   */ (function (e) {
    ...
    n(t, "Core/Chart/ChartNavigationComposition.js", [], function () {
          ...
          return (
            (function (t) {
              ...
              function k(e) {
                ...
                s
                  ...
                  r.text && r.symbol
                    ...
                    : r.text ||
                      b(c, { width: r.width, height: r.height, padding: 0 });
                let p = o
                  .button(
                    r.text,
                    0,
                ...
                (p.menuClassName =
                  ...
                  p
                    ...
                    .align(
                      b(r, { width: p.width, x: F(r.x, i.buttonOffset) }),
                      !0,
                      "spacingBox"
                    ),
                  (i.buttonOffset +=
              ...
              function G(t, n, i, o, r, s, l) {
                ...
                S ||
                  ...
                  (S.hideMenu = function () {
                    m(S, { display: "none" }),
                      l && l.setState(0),
                      (a.openMenu = !1),
                      m(a.renderTo, { overflow: "hidden" }),
                      m(a.container, { overflow: "hidden" }),
                      c.clearTimeout(S.hideTimer),
                      w(a, "exportMenuHidden");
                  }),
                  a.exportEvents.push(
                    f(S, "mouseleave", function () {
                      ...
                      t.separator
                        ...
                        : ("viewData" === t.textKey &&
                          ...
                          a.styledMode ||
                            ...
                            m(
                              n,
                              b({ cursor: "pointer" }, p.menuItemStyle || {})
                            ))),
                ...
                let F = { display: "block" };
                i + (a.exportMenuWidth || 0) > u
                  ? (F.right = u - i - r - v + "px")
                  : (F.left = i - v + "px"),
                  o + s + (a.exportMenuHeight || 0) > d &&
                  l.alignOptions?.verticalAlign !== "top"
                    ? (F.bottom = d - o - v + "px")
                    : (F.top = o + s - v + "px"),
                  m(S, F),
                  m(a.renderTo, { overflow: "" }),
                  m(a.container, { overflow: "" }),
                  (a.openMenu = !0),
                  w(a, "exportMenuShown");
              }
              function D(e) {
              ...
              function L(e) {
                ...
                this.axes.forEach(function (e) {
                  e.userOptions.internalKey ||
                    (e.userOptions.internalKey = O()),
                    e.options.isInternal ||
                      (c[e.coll] || ((c[e.coll] = !0), (i[e.coll] = [])),
                      i[e.coll].push(C(e.userOptions, { visible: e.visible })));
                }),
              ...
              function $(e, t) {
                ...
                return this.getSVG(
                  C({ chart: { borderRadius: 0 } }, n.chartOptions, t, {
                    exporting: {
              ...
              function q() {
                ...
                m(o, { width: "1px", height: "1px", visibility: "hidden" }),
                ...
                r && r.body.appendChild(r.createElementNS(d, "svg")),
                  (function t(o) {
                    ...
                    if (r && 1 === o.nodeType && -1 === P.indexOf(o.nodeName)) {
                      if (
                        ((s = g.getComputedStyle(o, null)),
                        (a =
                          "svg" === o.nodeName
                            ? {}
                            : g.getComputedStyle(o.parentNode, null)),
                        !i[o.nodeName])
                      ) {
              ...
              function z(e) {
                ...
                (t
                  ? [t.fixedDiv, t.scrollingContainer]
                  : [this.container]
                ).forEach(function (t) {
                  e.appendChild(t);
                });
              ...
              t.compose = function (e, t) {
                ...
                n.exportChart ||
                  ...
                  f(e, "init", V),
                  l.isSafari &&
                    g.matchMedia("print").addListener(function (e) {
      ...
      n(
        ...
        function (e, t, n) {
          return (
            (e.HttpUtilities = e.HttpUtilities || n),
