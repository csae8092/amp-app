!(
   ...
   */ (function (e) {
    "object" == typeof module && module.exports
      ...
      ? define("highcharts/modules/data", ["highcharts"], function (t) {
    ...
    s(
      ...
      function (e, t) {
        let { win: s } = e,
          { discardElement: r, objectEach: i } = t,
          a = {
            ajax: function (e) {
              let t = {
            ...
            post: function (e, t, a) {
              ...
              i(t, function (e, t) {
                ...
                n.append("b64", "true");
              let { filename: o, type: l } = t;
              return s.fetch(e, { method: "POST", body: n, ...a }).then((e) => {
                e.ok &&
                  e.text().then((e) => {
                    let t = document.createElement("a");
                    (t.href = `data:${l};base64,${e}`),
                      (t.download = o),
                      t.click(),
                      r(t);
                  });
      ...
      s(
        ...
        function (e, t, s, r, i, a, n) {
          ...
          class v {
            ...
            constructor(e, t = {}, s) {
              (this.rowsToColumns = v.rowsToColumns),
                (this.dateFormats = {
                  "YYYY/mm/dd": {
            ...
            init(e, t, s) {
              ...
              t && (this.chartOptions = t),
                ...
                (this.rawColumns = []),
                this.columns.length && (this.dataFound(), (i = !T(e))),
                i || (i = this.fetchLiveData()),
                i || (i = !!this.parseCSV().length),
                i || (i = !!this.parseTable().length),
                i || (i = this.parseGoogleSpreadsheet()),
                !i && e.afterComplete && e.afterComplete();
            }
            getColumnDistribution() {
              let e = this.chartOptions,
                ...
                s = [],
                r = function (e) {
                  return (u[e || "line"].prototype.pointArrayMap || [0]).length;
                },
                i = function (e) {
                  return u[e || "line"].prototype.pointArrayMap;
                },
              ...
              ((e && e.series) || []).forEach((e) => {
                ...
                l.forEach((t) => {
                  let s = new R(),
                    ...
                    p = c || ["y"];
                  for (
                    (m(t.x) || u.isCartesian || !c) &&
                      s.addColumnReader(t.x, "x"),
                      C(t, function (e, t) {
                    ...
                    s.hasReader(p[h]) || s.addColumnReader(void 0, p[h]);
                  o.push(s), d++;
                });
              let c = i(a);
              void 0 === c && (c = ["y"]),
            ...
            parseCSV(e) {
              let t = this,
                ...
                r = e || this.options,
                i =
                  void 0 !== r.startColumn && r.startColumn ? r.startColumn : 0,
                a = r.endColumn || Number.MAX_VALUE,
                n = [],
                o = { ",": 0, ";": 0, "	": 0 },
                l = r.csv,
                d = void 0 !== r.startRow && r.startRow ? r.startRow : 0,
                u = r.endRow || Number.MAX_VALUE,
                h,
                m,
                c = 0;
              if (
                (l && r.beforeParse && (l = r.beforeParse.call(this, l)), l)
              ) {
                if (
                  ((m = l
                    .replace(/\r\n/g, "\n")
                  ...
                  (h = null),
                    ...
                    m.some(function (t, r) {
                      ...
                      for (let r = 0; r < t.length; r++) {
                        ...
                        if ('"' === a) {
                          if (i) {
                            if ('"' !== l && '"' !== n) {
                              for (; " " === n && r < t.length; ) n = t[++r];
                              void 0 !== o[n] && o[n]++, (i = !1);
                            }
                          } else i = !0;
                        } else
                          void 0 !== o[a]
                            ? (isNaN(Date.parse((d = d.trim())))
                                ? (isNaN(d) || !isFinite(d)) && o[a]++
                                : o[a]++,
                              (d = ""))
                            : (d += a);
                        "," === a && s++, "." === a && e++;
                    ...
                    o[";"] > o[","] ? (i = ";") : (o[","], o[";"], (i = ",")),
                    r.decimalPoint ||
                      (e > s ? (r.decimalPoint = ".") : (r.decimalPoint = ","),
                      (t.decimalRegex = RegExp(
                        "^(-?[0-9]+)" + r.decimalPoint + "([0-9]+)$"
                      ))),
                    (h = i);
                }
                let e = 0;
                        ...
                        function y() {
                          ...
                          r.columnTypes ||
                            (!isNaN(parseFloat(p)) && isFinite(p)
                              ? ((p = parseFloat(p)), x("number"))
                              : isNaN(Date.parse(p))
                              ? x("string")
                              : ((p = p.replace(/\//g, "-")), x("date"))),
                            s.length < g + 1 && s.push([]),
                            (s[g][t] = p),
                            (p = ""),
                            ++g,
                ...
                (!r.columnTypes || 0 === r.columnTypes.length) &&
                  n.length &&
                  n[0].length &&
                  "date" === n[0][1] &&
                  !r.dateFormat &&
                  (r.dateFormat = (function (e, s) {
                    let i = "YYYY/mm/dd",
                      a = [],
                      n = [],
                      o,
                      ...
                      for (m = 0; m < a.length; m++)
                        !1 !== a[m]
                          ? n[m] > 12 &&
                            ...
                            "YYYY" !== l[m] &&
                            (l[m] = "YY")
                          : n[m] > 12 && "mm" === l[m] && (l[m] = "dd");
                      return (3 === l.length &&
                        "dd" === l[1] &&
                        "dd" === l[2] &&
                        (l[2] = "YY"),
                      (d = l.join("/")),
                      (r.dateFormats || t.dateFormats)[d])
                        ? d
                        : (p("deduceDateFailed"), i);
                    }
                    return i;
                  })(s[0])),
                  this.dataFound();
            ...
            parseTable() {
              ...
              if (e.table) {
                let n = e.table;
                "string" == typeof n && (n = l.getElementById(n)),
                  [].forEach.call(n.getElementsByTagName("tr"), (e, n) => {
                    n >= s &&
                      n <= r &&
                      [].forEach.call(e.children, (e, r) => {
                        let o = t[r - i],
                          l = 1;
                        if (
            ...
            fetchLiveData() {
              ...
              return (
                ...
                (function o(l) {
                  function u(i, u, h) {
                    if (!i || !/^(http|\/|\.\/|\.\.\/)/.test(i))
                      return i && s.error && s.error("Invalid URL"), !1;
                    function m() {
                      r &&
                        t.liveDataURL === i &&
                    ...
                    return (
                      l &&
                        (clearTimeout(e.liveDataTimeout), (t.liveDataURL = i)),
                      d({
                        url: i,
                        dataType: h || "json",
                        success: function (e) {
                  ...
                  u(
                    ...
                    u(i.rowsURL, function (e) {
                      t.update({ data: { rows: e } });
                    }) ||
                    u(i.columnsURL, function (e) {
            ...
            trim(e, t) {
              return (
                "string" == typeof e &&
                  ...
                  this.decimalRegex &&
                    (e = e.replace(this.decimalRegex, "$1.$2"))),
                e
              );
            }
            parseTypes() {
            ...
            parseColumn(e, t) {
              let s = this.rawColumns,
                ...
                d =
                  (a && o && o.xAxis && "category" === y(o.xAxis)[0].type) ||
                  "string" === l,
                u = m(e.name),
                h = e.length,
                c,
              ...
              for (s[t] || (s[t] = []); h--; )
                (c = n[h] || e[h]),
                  (g = this.trim(c)),
                  (p = parseFloat((C = this.trim(c, !0)))),
                  void 0 === s[t][h] && (s[t][h] = g),
                  d || (0 === h && i && !u)
                    ? (e[h] = "" + g)
                    : +C === p
                    ? ((e[h] = p),
                      p > 31536e6 && "float" !== l
                        ? (e.isDatetime = !0)
                        : (e.isNumeric = !0),
                      void 0 !== e[h + 1] && (v = p > e[h + 1]))
                    : (g && g.length && (x = this.parseDate(c)),
                      a && f(x) && "float" !== l
                        ? ((n[h] = c),
                          (e[h] = x),
                          (e.isDatetime = !0),
              ...
              if ((a && e.mixed && (r[t] = s[t]), a && v && this.options.sort))
                for (t = 0; t < r.length; t++)
                  r[t].reverse(), i && r[t].unshift(r[t].pop());
            }
            parseDate(e) {
              ...
              if (t) s = t(e);
                ...
                if (a)
                  (i = this.dateFormats[a]) ||
                    (i = this.dateFormats["YYYY/mm/dd"]),
                    (n = e.match(i.regex)) && (s = i.parser(n));
                else
                  for (r in this.dateFormats)
                    if (((i = this.dateFormats[r]), (n = e.match(i.regex)))) {
                      (this.dateFormat = a = r),
                        (this.alternativeFormat = i.alternative),
                        (s = i.parser(n));
                      break;
                    }
                !n &&
                  ...
                  "object" == typeof (n = Date.parse(e)) &&
                  null !== n &&
                  n.getTime
                    ? (s = n.getTime() - 6e4 * n.getTimezoneOffset())
                    : f(n) && (s = n - 6e4 * new Date(n).getTimezoneOffset()));
              }
              return s;
            }
            getData() {
                  ...
                  n = 0,
                    ...
                    d = (function (e, t) {
                      ...
                      for (s = 0; s < t.length; s += 1)
                        for (
                          r = 0, i = t[s].getReferencedColumnIndexes();
                          r < i.length;
                          r += 1
                        )
                          a[i[r]] = !1;
                      ...
                      return n;
                    })(c.length, this.valueCount.seriesBuilders);
                  n < this.valueCount.seriesBuilders.length;
                  n++
                )
                  (l = this.valueCount.seriesBuilders[n]).populateColumns(d) &&
                    f.push(l);
                for (; d.length > 0; ) {
                  for (
                    (l = new R()).addColumnReader(0, "x"),
                      -1 !== (h = d.indexOf(0)) && d.splice(h, 1),
                      r = 0;
                    r < this.valueCount.global;
                    r++
                  )
                    l.addColumnReader(
                      void 0,
                      this.valueCount.globalPointArrayMap[r]
                    );
                  l.populateColumns(d) && f.push(l);
                }
                if (
                  (f.length > 0 &&
                    f[0].readers.length > 0 &&
                    void 0 !== (u = c[f[0].readers[0].columnIndex]) &&
                    (u.isDatetime
                      ? (e = "datetime")
                      : u.isNumeric || (e = "category")),
                  "category" === e)
                )
                  for (n = 0; n < f.length; n++)
                    for (a = 0, l = f[n]; a < l.readers.length; a++)
                      "x" === l.readers[a].configName &&
                        (l.readers[a].configName = "name");
                for (n = 0; n < f.length; n++) {
                  for (i = 0, l = f[n], s = []; i < c[0].length; i++)
                    s[i] = l.read(c, i);
                  (t[n] = { data: s }),
                    l.name && (t[n].name = l.name),
                    "category" === e && (t[n].turboThreshold = 0);
                }
                (o = { series: t }),
                  e &&
                    ((o.xAxis = { type: e }),
                    "category" === e && (o.xAxis.uniqueNames = !1)),
                  p.complete && p.complete(o),
                  p.afterComplete && p.afterComplete(o);
              }
            }
            update(e, t) {
              let s = this.chart,
                r = s.options;
              e &&
                ((e.afterComplete = function (e) {
                  e &&
                    (e.xAxis &&
                      s.xAxis[0] &&
                      e.xAxis.type === s.xAxis[0].options.type &&
                      delete e.xAxis,
                    s.update(e, t, !0));
                }),
                g(!0, r.data, e),
                r.data &&
                  r.data.googleSpreadsheetKey &&
                  !e.columns &&
                  delete r.data.columns,
                this.init(r.data));
            }
          }
          h(e, "init", function (e) {
            ...
            read(e, t) {
              ...
              if (
                (this.readers.forEach((a) => {
                  ...
                  s
                    ? r.push(n)
                    : a.configName.indexOf(".") > 0
                    ? i.prototype.setNestedProperty(r, n, a.configName)
                    : (r[a.configName] = n);
                }),
      ...
      s(
        t,
        "masters/modules/data.src.js",
        [
          t["Core/Globals.js"],
          t["Core/HttpUtilities.js"],
          t["Extensions/Data.js"],
        ],
        function (e, t, s) {
          return (
            (e.Data = e.Data || s),
            (e.HttpUtilities = e.HttpUtilities || t),
