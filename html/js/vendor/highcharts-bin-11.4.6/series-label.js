   ...
   */ (function (t) {
    ...
    o(e, "Extensions/SeriesLabel/SeriesLabelDefaults.js", [], function () {
      ...
      o(e, "Extensions/SeriesLabel/SeriesLabelUtilities.js", [], function () {
        ...
        function e(e, o, r, i, a, n, s, l) {
          return (
            t(e, o, a, n, s, l) !== t(r, i, a, n, s, l) &&
            t(e, o, r, i, a, n) !== t(e, o, r, i, s, l)
          );
        }
        return {
          boxIntersectLine: function (t, o, r, i, a, n, s, l) {
            return (
              e(t, o, t + r, o, a, n, s, l) ||
              e(t + r, o, t + r, o + i, a, n, s, l) ||
              e(t, o + i, t + r, o + i, a, n, s, l) ||
              e(t, o, t, o + i, a, n, s, l)
            );
          },
      ...
      o(
        ...
        function (t, e, o, r, i, a, n) {
          let { animObject: s } = t,
            ...
            { setOptions: h } = o,
            { composed: c } = r,
            { boxIntersectLine: p, intersectRect: u } = a,
            {
              addEvent: d,
              extend: f,
              fireEvent: x,
          ...
          function X(t, e, o, r, i) {
            let a = t.chart,
              n = t.options.label || {},
              s = m(n.onArea, !!t.area),
              l = s || n.connectorAllowed,
              h = a.boxesToAvoid,
              c = Number.MAX_VALUE,
              d = Number.MAX_VALUE,
              f,
            ...
            for (X = 0; X < a.series.length; X += 1) {
              let h = a.series[X],
                u = h.interpolatedPoints && [...h.interpolatedPoints];
              if (h.visible && u) {
                let m = a.plotHeight / 10;
                for (let t = a.plotTop; t <= a.plotTop + a.plotHeight; t += m)
                  u.unshift({ chartX: a.plotLeft, chartY: t }),
                    u.push({ chartX: a.plotLeft + a.plotWidth, chartY: t });
                for (S = 1; S < u.length; S += 1) {
                  if (
                    u[S].chartX >= e - 16 &&
                    u[S - 1].chartX <= e + r.width + 16
                  ) {
                    if (
                      p(
                        e,
                  ...
                  (l || b) &&
                    ...
                    (c = Math.min(
                      c,
                      (g = e + r.width / 2 - u[S].chartX) * g +
                        (y = o + r.height / 2 - u[S].chartY) * y
                    ));
                }
                if (
                  !s &&
                  ...
                  t === h &&
                  ((i && !b) ||
                    c < Math.pow(n.connectorNeighbourDistance || 1, 2))
                ) {
                  for (S = 1; S < u.length; S += 1)
                    (f = Math.min(
                      Math.pow(e + r.width / 2 - u[S].chartX, 2) +
                        Math.pow(o + r.height / 2 - u[S].chartY, 2),
                      Math.pow(e - u[S].chartX, 2) +
                        Math.pow(o - u[S].chartY, 2),
                      Math.pow(e + r.width - u[S].chartX, 2) +
                        Math.pow(o - u[S].chartY, 2),
                      Math.pow(e + r.width - u[S].chartX, 2) +
                        Math.pow(o + r.height - u[S].chartY, 2),
                      Math.pow(e - u[S].chartX, 2) +
                        Math.pow(o + r.height - u[S].chartY, 2)
                    )) < d && ((d = f), (x = u[S]));
                  b = !0;
                      ...
                      (function (t) {
                        ...
                        t.series.forEach((t) =>
                          ...
                          e.forEach(function (t) {
                            ...
                            (t.interpolatedPoints = (function (t) {
                              ...
                              let n = t.points,
                                ...
                                x = c ? p.len : u.len,
                                g = c ? u.len : p.len,
                                y = m((t.options.label || {}).onArea, !!t.area),
                                X = u.getThreshold(t.options.threshold),
                                S = {},
                                M = c ? "chartCenterX" : "chartCenterY";
                              function w(t) {
                                let e =
                              ...
                              if (
                                ...
                                let t = l.toD && l.attr("d");
                                for (
                                  l.toD && l.attr({ d: l.toD }),
                                    r = h.getTotalLength(),
                                    e = 0;
                                  e < r;
                                  e += 16
                                ) {
                                  let t = h.getPointAtLength(e),
                                    o = c ? g - t.y : t.x,
                                    r = c ? x - t.x : t.y;
                                  w({
                                    chartX: d + o,
                          ...
                          t.series.forEach(function (e) {
                            ...
                            let r =
                                "highcharts-color-" + m(e.colorIndex, "none"),
                              i = !e.labelBySeries,
                              a = o.minFontSize,
                              n = o.maxFontSize,
                              h = t.inverted,
                              c = h ? e.yAxis.pos : e.xAxis.pos,
                              p = h ? e.xAxis.pos : e.yAxis.pos,
                              u = t.inverted ? e.yAxis.len : e.xAxis.len,
                              d = t.inverted ? e.xAxis.len : e.yAxis.len,
                              ...
                              C;
                            function P(t, e, o) {
                              let r = Math.max(c, m(T, -1 / 0)),
                                i = Math.min(c + u, m(C, 1 / 0));
                              return (
                                t > r &&
                                t <= i - o.width &&
                                e >= p &&
                            ...
                            if (
                              (b &&
                                !h &&
                                ((E = [
                                  e.xAxis.toPixels(y[0]),
                                  e.xAxis.toPixels(y[y.length - 1]),
                                ]),
                              ...
                              for (
                                (S = v.getBBox()).width = Math.round(S.width),
                                  Y = x.length - 1;
                                Y > 0;
                                Y -= 1
                              )
                                b
                                  ? P(
                                      (M =
                                        (x[Y].chartCenterX ?? x[Y].chartX) -
                                        S.width / 2),
                                      (w =
                                        (x[Y].chartCenterY ?? x[Y].chartY) -
                                        S.height / 2),
                                      S
                                    ) && (L = X(e, M, w, S))
                                  : (P(
                                      (M = x[Y].chartX + 3),
                                      (w = x[Y].chartY - S.height - 3),
                                      S
                                    ) && (L = X(e, M, w, S, !0)),
                                    L && g.push(L),
                                    P(
                                  ...
                                  L && g.push(L);
                              if (o.connectorAllowed && !g.length && !b)
                                for (M = c + u - S.width; M >= c; M -= 16)
                                  for (w = p; w < p + d - S.height; w += 16)
                                    (A = X(e, M, w, S, !0)) && g.push(A);
                              if (g.length) {
          ...
          return {
            compose: function (t, e) {
              g(c, "SeriesLabel") &&
                (d(t, "load", S),
                d(t, "redraw", S),
                (e.prototype.symbols.connector = M),
                h({ plotOptions: { series: { label: i } } }));
            },
          };
        }
      ),
      o(
        ...
        function (t, e) {
          return e.compose(t.Chart, t.SVGRenderer), t;
        }
      );
  })
);
