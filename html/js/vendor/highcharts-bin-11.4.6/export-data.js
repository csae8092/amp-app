        ...
        function (t, e, o, a, n, i) {
              ...
              if (
                ...
                (b = {
                  ...
                  e.options.data.forEach(function (t, o) {
                    ...
                    for (
                      s[r].x = m.x, s[r].name = y, s[r].xValues[g] = m.x;
                      v < p;
                ...
                l.forEach(function (t) {
                  ...
                  v &&
                    ...
                    (v.dateTime
                      ...
                      : (e = v.categories
                          ? f(v.names[t.x], v.categories[t.x], t.x)
                          : t.x)),
                    t.splice(o, 0, e);
                });
            return g(this, "exportData", { dataRows: (E = E.concat(l)) }), E;
          }
          function v(t) {
            let e = (t) => {
          ...
          function E(t) {
            ...
            r.forEach(function (t) {
              ...
              for (let a = 0; a < e; a++)
                o.push(
                  c(a ? "td" : "th", null, a ? {} : { scope: "row" }, t[a])
                );
          ...
          function S(e) {
            ...
            if (
              ...
              (a.display = e ? "block" : "none"),
                e
                  ? ((this.dataTableDiv.innerHTML = t.emptyHTML),
          ...
          function A(t, e) {
            ...
            try {
              ...
              return a.createObjectURL(new c.Blob(["\uFEFF" + t], { type: e }));
            } catch (t) {}
          }
          function R() {
            let t = this,
          ...
          return {
            compose: function (t, e) {
              ...
              if (!o.getCSV) {
                ...
                i && (i.prototype.keyToAxis = { low: "y", high: "y" }),
                  l &&
                    ((l.prototype.exportKey = "name"),
                    (l.prototype.keyToAxis = { start: "x", end: "x" })),
