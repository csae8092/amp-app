                        ...
                        <tbody>
                            ...
                            <tr>                                                                                                       
                                ...
                                <td>
                                    ...
                                    <a href="{concat('https://amp.acdh.oeaw.ac.at', '/', replace(tokenize($full_path, '/')[last()], '.xml', '.html'))}">
                                        <xsl:value-of select="concat('amp.acdh.oeaw.ac.at', '/' ,replace(tokenize($full_path, '/')[last()], '.xml', '.html'))"/></a><xsl:text>.</xsl:text>       
                                    <xsl:text> Acessed </xsl:text><span id="citation-date">Please activate JavaScript and reload page!</span><xsl:text>.</xsl:text> 
                                </td>                                                                                                               
                            </tr>
                        </tbody>
                    </table>
